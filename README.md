...
To debug the cause of this, I checked the deployment flow log and discovered that an apt-get process was holding the deployment so it timed out. I went into the 
